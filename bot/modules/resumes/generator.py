...
def create_resume_docx(user_details, summary, experience, projects, skills, certificates):
    ...
    doc.add_paragraph(user_details['email'] + ' | ' +
                      user_details['phone_number'] + ' | ' + user_details['address'])
    ...
    for experience_item in experience:
        ...
        doc.add_paragraph(
            experience_item['role'] + ' | ' + experience_item['dates'])
    ...
    pdf.cell(0, 10, user_details['email'] + ' | ' +
             user_details['phone_number'] + ' | ' + user_details['address'], 0, 1, 'L')
    ...
    for experience_item in experience:
        ...
        pdf.cell(0, 10, experience_item['role'] +
                 ' | ' + experience_item['dates'], 0, 1, 'L')
