...
def createChromeSession(isRetry: bool = False):
    ...
    if isRetry:
        print_lg(
            "Will login with a guest profile, browsing history will not be saved in the browser!")
    ...
    if stealth_mode:
        ...
        # version_main must match installed Chrome major version (e.g. 145) to avoid SessionNotCreatedException
    ...
    try:
        ...
        print_lg("Window closed or not ready; continuing without maximize.")
